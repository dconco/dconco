   ...
   return (
      <main className="mx-auto max-w-7xl space-y-12 px-6 pb-24 pt-32 md:px-12 lg:px-24">
         ...
         <section className="grid grid-cols-1 gap-6 md:grid-cols-12">
            <article className="relative overflow-hidden rounded-xl bg-surface-container-low p-8 md:col-span-8 md:p-12">
               ...
               <form className="relative z-10 space-y-8">
                  ...
                  <label className="space-y-2">
                     ...
                     <select className="w-full cursor-pointer appearance-none rounded-lg border-none bg-surface-container p-4 text-on-surface focus:ring-2 focus:ring-primary/50">
                  ...
                  <div className="flex flex-col gap-4 pt-2 sm:flex-row sm:items-center sm:justify-between">
                     ...
                     <button
                        type="button"
                        className="inline-flex items-center justify-center gap-2 rounded-full bg-primary-container px-10 py-4 text-sm font-black uppercase tracking-widest text-on-primary-container transition-opacity hover:opacity-90"
                     >
                        Send Inquiry
                        <Icon
            ...
            <div className="flex flex-col gap-6 md:col-span-4">
               <article className="rounded-xl border-l-4 border-primary bg-surface-container-high p-8">
                  ...
                  <p className="text-xl leading-relaxed">
                     ...
                     <span className="font-bold text-primary">Q3 2024</span>.
                  </p>
               </article>
               ...
               <article className="rounded-xl bg-surface-container p-8">
                  ...
                  <div className="space-y-6">
                     <a
                        href="mailto:hello@elitecurator.com"
               ...
               <article className="group relative h-48 overflow-hidden rounded-xl bg-surface-container-lowest p-8">
                  <img
